...
export default class Dialog extends LightningElement {
  ...
  get _body() {
    return this.querySelector('[data-id="body"]');
  }
  ...
  disconnectedCallback() {
    ...
    this._body?.removeEventListener("click", this._outsideClickListener);
  }
  ...
  renderedCallback() {
    if (this._isFirstRender) {
      ...
      const attribute = this.labelledBy ? "aria-labelledby" : "aria-label";
